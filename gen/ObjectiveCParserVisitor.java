...
public interface ObjectiveCParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link ObjectiveCParser#conditionStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConditionStatement(ObjectiveCParser.ConditionStatementContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link ObjectiveCParser#functionCall}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunctionCall(ObjectiveCParser.FunctionCallContext ctx);
	/**
